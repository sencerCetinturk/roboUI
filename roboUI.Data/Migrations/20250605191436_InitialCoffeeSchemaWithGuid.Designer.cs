...
namespace roboUI.Data.Migrations
{
    ...
    [Migration("20250605191436_InitialCoffeeSchemaWithGuid")]
    partial class InitialCoffeeSchemaWithGuid
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("roboUI.Core.Models.OptionGroup", b =>
                {
                    ...
                    b.Property<bool>("IsRequiredForProduct")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("roboUI.Core.Models.OrderItemChoiceSelection", b =>
                {
                    ...
                    b.Property<Guid>("OptionChoideId")
                        .HasColumnType("TEXT");
